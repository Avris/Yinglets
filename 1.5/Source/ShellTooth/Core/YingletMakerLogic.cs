        ...
        public Pawn ReplaceWithYing(Pawn pawn)
        {
            ...
            if (pawn.def.race.Humanlike)
            {
                ...
                if (pawn.def.defName != "Alien_Younglet")
                {
                    ...
                    if (pawn.story.traits.HasTrait(TraitDef.Named("Beauty")))
                    {
                        Trait pawnBeauty = pawn.story.traits.allTraits[pawn.story.traits.allTraits.FindIndex((Trait tr) => tr.def == TraitDef.Named("Beauty"))];
                        if (newbie.story.traits.HasTrait(TraitDef.Named("Beauty")))
                        {
                            pawnBeauty = newbie.story.traits.allTraits[newbie.story.traits.allTraits.FindIndex((Trait tr) => tr.def == TraitDef.Named("Beauty"))];
                        }
                        else
                        {
